...
const Page = async () => {
  ...
  return (
    <div className="custom-scrollbar mx-2 max-h-[80vh] w-full overflow-y-scroll rounded-xl border shadow-lg dark:bg-slate-950 dark:shadow-[2px_4px_16px_0px_rgba(248,248,248,0.06)_inset]">
