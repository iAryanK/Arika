  ...
  return (
    <main>
      ...
      <div className="flex flex-col items-center justify-between md:flex-row">
        ...
        <div className="h-screen w-full bg-black/[0.6] backdrop-blur-sm dark:bg-zinc-900/[0.6] max-md:rounded-t-3xl max-md:border-t md:w-1/2 md:overflow-y-scroll md:border-l">
          {children}
        </div>
      </div>
    </main>
