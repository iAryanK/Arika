...
const ProfilePhone = async () => {
  ...
  return (
    <div className="relative mx-auto h-[600px] w-fit rounded-[2.5rem] border-[14px] border-gray-500 bg-gray-500 shadow-xl dark:border-gray-800 dark:bg-gray-800 max-md:hidden">
